...
![VNS Registration](https://user-images.githubusercontent.com/98585076/258826386-cf0ccb52-df66-492a-8359-222f9832fe9c.png)

#### Smart Contracts
VNS Domains based its smart contracts off of the longstanding and well known [Ethereum Name Service](https://github.com/ensdomains/ens-contracts) with the following notable features:
...
#### Documentation
VNS Domains has a documentation consisting of frequently asked questions, policies and terminology. This documentation will be regularly updated as needed.
...
Social Media: Utilize Twitter (https://vns.domains), Medium and Reddit as primary platforms for community engagement and updates on the development of the VNS (Testnet and Main Launch).
